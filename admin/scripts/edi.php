...
if($_POST['inversion'] != " "){
	$query_usuarios = "UPDATE propiedades SET inversion = '".$_POST['inversion']."' WHERE codigo = '".$_POST['cod']."'";
	$usuariorecord = mysqli_query($landier, $query_usuarios) ;	
}
if($_POST['incluyeinversion'] != " "){
	$query_usuarios = "UPDATE propiedades SET incluyeinversion = '".$_POST['incluyeinversion']."' WHERE codigo = '".$_POST['cod']."'";
	$usuariorecord = mysqli_query($landier, $query_usuarios) ;	
}
if($_POST['proyecto'] != " "){
	$query_usuarios = "UPDATE propiedades SET proyecto = '".$_POST['proyecto']."' WHERE codigo = '".$_POST['cod']."'";
	$usuariorecord = mysqli_query($landier, $query_usuarios) ;	
}
if($_POST['rendimiento'] != " "){
	$query_usuarios = "UPDATE propiedades SET rendimiento = '".$_POST['rendimiento']."' WHERE codigo = '".$_POST['cod']."'";
	$usuariorecord = mysqli_query($landier, $query_usuarios) ;	
}
if($_POST['cadena'] != " "){
	$query_usuarios = "UPDATE propiedades SET cadena = '".$_POST['cadena']."' WHERE codigo = '".$_POST['cod']."'";
	$usuariorecord = mysqli_query($landier, $query_usuarios) ;	
}
if($_POST['tiempo'] != " "){
	$query_usuarios = "UPDATE propiedades SET tiempo = '".$_POST['tiempo']."' WHERE codigo = '".$_POST['cod']."'";
	$usuariorecord = mysqli_query($landier, $query_usuarios) ;	
}
